...
public class Main {
    ...
    public static void admin() {
        ...
        if (usernameAdmin.equals("admin475") && passwordAdmin.equals("password475")) {
    ...
    public static void mahasiswa() {
        ...
        if (usernamemahasiswa.equals("DAFFAFARRELLNURHABIBI") && passwordmahasiswa.equals("202410370110475")) {
